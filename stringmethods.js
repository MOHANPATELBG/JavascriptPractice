...
console.log("Character at index 0:", a.charAt(0)); // "H"
console.log("Character code at index 0:", str.charCodeAt(0)); // 72
...
console.log("Slice from index 0 to 5:", str.slice(0, 5)); // "Hello" 
...
console.log("Character at index 0:", str.charAt(0)); // "H"
console.log("Starts with 'Hello':", str.startsWith("Hello")); // true
console.log("Ends with '!':", str.endsWith("!")); // true
console.log("Includes 'lo, Wo':", str.includes("lo, Wo")); // true    
console.log("Repeat 2 times:", str.repeat(2)); // "Hello, World!Hello, World!"
console.log("Trim:", str.trim()); // "Hello, World!"
console.log("Concat:", str.concat(" Welcome to string methods.")); // "Hello, World! Welcome to string methods."
...
console.log('Replace all "l" with "x" (using regex):', str.replace(/l/g, 'x')); // "Hexxo, Worxd!"    
console.log('Replace all function:', str.replaceAll("l", "x")); // "Hexxo, Worxd!"  
...
let str1 = ['jan', 'feb', 'mar', 'apr', 'may', 'jun', 'jul'];
let removed = str1.splice(2, 3, 'new1', 'new2'); // removes 3 elements starting from index 2 and adds new1 and new2
console.log('Removed elements:', removed);
console.log('Modified array:', str1);

let str2 = "Hello world, welcome to the universe.";
let deleted = str2.slice(0, 5); // removes the first 5 characters
console.log('Removed substring:', deleted);
console.log('Original string remains unchanged:', str2);

// Padding examples
let str3 = "5";
console.log('Pad start to length 4:', str3.padStart(4, '0')); // Output: "0005"
console.log('Pad end to length 4:', str3.padEnd(4, '0'));   // Output: "0005" and "5000"

let b = '';
console.log('Pad start to length 4:', b.padStart(1, '0'));
console.log('Pad end to length 4:', b.padEnd(1, '0'));
